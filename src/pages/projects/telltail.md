...
- A clickable concept prototype with clearly labelled sample data, used to test whether owners understand the insight and intended action.
- A small concierge pilot using owner observations and compatible or research-device data where appropriate, with human-reviewed summaries and explicit limitations.
- A narrow MVP with one reliable data source, an individual baseline, one or two interpretable change types, owner annotation, a safe next action, and a shareable history.
