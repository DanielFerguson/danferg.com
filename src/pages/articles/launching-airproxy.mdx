...
date: "2023-01-02"
imageUrl: /images/og/articles/launching-airproxy-og.png
imageUrls:
  - /images/og/articles/launching-airproxy-16x9.png
  - /images/og/articles/launching-airproxy-4x3.png
  - /images/og/articles/launching-airproxy-1x1.png
imageAlt: Social card for Launching Airproxy
imageWidth: 1200
imageHeight: 630
imageType: image/png
...
import airproxyLaunch from "../../assets/articles/launching-airproxy/airproxy_cta.jpg";
import airproxyDashboard from "../../assets/articles/launching-airproxy/airproxy_screenshot.webp";
...
<Picture
  src={airproxyDashboard}
  formats={["avif", "webp"]}
  fallbackFormat="webp"
  widths={[360, 720, 1080]}
  width={720}
  sizes="(max-width: 760px) calc(100vw - 40px), 720px"
  alt="Airproxy dashboard showing cached Airtable API activity"
  loading="lazy"
  decoding="async"
/>
